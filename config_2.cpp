...
int main(int argc, char** argv) {
    ...
    fact.addCol(CT_STRING, 102); // comment
    ...
    // Load the tables
    fact.loadFromFile(string("SkewedDataGenerator/zipf2/supplier.tbl"), '|');
